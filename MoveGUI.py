...
#Creation of init_window
    def init_window(self):
        ...
        button_rEnable = tk.Button(self, repeatdelay=500, repeatinterval=1200, text="Enable magnet +", command=lambda: self.r_enable())
        button_rDisable = tk.Button(self, repeatdelay=500, repeatinterval=1200, text="Disable magnet -", command=lambda: self.r_disable())
        ...
        button_rEnable.place(x=235, y=160)
        button_rDisable.place(x=235, y=200)
    ...
    def r_move_y_axis(self, direction):
        ...
        if direction == "positive":
            ...
            # magnet
            # script = "set_digital_out({}, {})".format(8, true) + "\n"
